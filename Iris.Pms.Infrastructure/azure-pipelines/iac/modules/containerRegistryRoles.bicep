// File: containerRegistryRoles.bicep
// Author: Bunny Davies
...
resource cr 'Microsoft.ContainerRegistry/registries@2023-11-01-preview' existing = {
  name: crName
}
...
resource roleAssignments 'Microsoft.Authorization/roleAssignments@2022-04-01' = [
  for role in roleIds: {
    scope: cr
    name: guid(cr.id, principalId, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', role))
    properties: {
